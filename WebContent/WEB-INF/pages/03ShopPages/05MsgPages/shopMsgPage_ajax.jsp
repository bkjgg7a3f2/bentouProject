...
<body>
	<div id="contentWith${cstmr_id }"></div>
</body>
...
<%=request.getAttribute("JSON_dialogue")%>
	;
	//取得寫入Div
	var divID = "contentWith${cstmr_id}";
	...
	//說話對象圖片字串
	var imgShopStr_ajax = "<img name=\"customerPic\" src=\"/cstmrPics/${cstmr_image}\" class=\"mh-100 rounded-circle\" style=\"height:3em;max-width:3em; object-fit: cover\">"
	...
	$("div[name='shop']").addClass(divSettings.myClass)
			.wrap(divSettings.myDiv);
	$("div[name='customer']").addClass(divSettings.yourClass).wrap(
			divSettings.yourDiv).before(imgShopStr_ajax);
	$("img[name='customerPic']").one("error", function(e) {
		$(this).attr("src", "/cstmrPics/default.jpg");
	});
