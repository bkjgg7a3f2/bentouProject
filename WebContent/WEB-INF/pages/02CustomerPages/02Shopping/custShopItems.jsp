...
<body>
	...
	<div class="container " style="margin-bottom: 45pt;">
		<div class="row my-md-4">
					...
					<div class="row">
						<div class="col-sm-6 align-right">
							<figure id="figZone" class="figure text-right"
								style="height: 150px;">
								<img id="figPicPre" src="/supplyPics/default.jpg"
							...
							<figure id="figZone2" class="figure text-right d-none"
								style="height: 150px;">
								<img id="figPic" src="/supplyPics/default.jpg"
									class="figure-img img-fluid rounded h-100 invisible"
									style="height: 100%; object-fit: cover;">
			...
			<div class="col-2">
				<div class="card">
					<img id="shopPics" src="/supplyPics/${supply_image }" class="card-img-top" alt="...">
					<div class="card-body">
						...
						<a href='<c:url value="/cstmr/shoppingcart" />'
							class="btn btn-warning">前往購物車</a>
					</div>
				</div>
			</div>
		</div>
	...
	<%=request.getAttribute("JSON_supply_sales")%>
		...
		//空格檢查
		function chk() {
			var s = document.getElementById("hiddenInput1").value;
			var i = document.getElementById("itemNum").value;
