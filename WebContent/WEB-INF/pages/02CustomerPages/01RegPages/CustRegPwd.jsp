...
<body>
	<c:import url="/TopSec" />
	<h5 class="my-4" style="text-align: center">修改密碼－消費者</h5>

	<div class="container" style="margin-bottom: 45pt;">
		<form action="<c:url value="/cstmr/data/account/update_fail" />" method="post">
			<div class="row">
				<div class="col"></div>
				<div class="col-6">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<small id="changePwdMsg" class="form-text text-danger text-right" >${ChangePwdMsg }</small>
						</div>
