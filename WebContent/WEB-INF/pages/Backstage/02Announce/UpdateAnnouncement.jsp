...
<body>
	<form action="<c:url value="/manager/announcementUpdate" />"
		onsubmit="return chk()" method="post" enctype="multipart/form-data">
		<input type="hidden" name="announcement_id"
			value="${MAP_Announcement_PreUpdate.announcement_id}">
		<div class="d1">
			<table style="margin-left: 30px">
				<tr>
					...
					<td><input type="text" name="title"
						...
						id="inputTitle"
						value="${MAP_Announcement_PreUpdate.announcement_title}"></td>
				</tr>
				<tr style="height: 250px;">
					<td align="center">
						<div>
							<figure class="figure w-100"> <img id="img1"
								src="/billboardPics/${MAP_Announcement_PreUpdate.announcement_picture1}"
				...
				<tr>
					...
					<td><textarea name="content"
							...
							style="max-width: 25em; height: 120px;">${MAP_Announcement_PreUpdate.announcement_content}</textarea></td>
				</tr>
				<tr style="height: 250px;">
					<td align="center">
						<div>
							<figure class="figure w-100"> <img id="img2"
								src="/billboardPics/${MAP_Announcement_PreUpdate.announcement_picture2}"
								class="figure-img img-fluid rounded"
								style="height: 225px; width: 225px" alt="內容圖片預覽區（一）"> <figcaption
								style="font-size: 13px; font-style: italic"
					...
					<td align="center">
						<div>
							<figure class="figure w-100"> <img id="img3"
								src="/billboardPics/${MAP_Announcement_PreUpdate.announcement_picture3}"
								class="figure-img img-fluid rounded"
				...
				<tr>
					...
					<td><label><input type="radio" name="status"
							value="on" id="yes" checked />上架</label> <label><input
							type="radio" name="status" value="off" id="no"
							${MAP_Announcement_PreUpdate.announcement_status} />下架</label></td>
